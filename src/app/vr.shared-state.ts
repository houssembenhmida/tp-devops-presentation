...
export class VrSharedState {
  ...
  //public apiRoot: string = 'http://service-tp-devops.192.168.99.100.nip.io/ws/core';
  public apiRoot: string = 'http://service-tp-devops-final.192.168.99.100.nip.io/ws/core';
